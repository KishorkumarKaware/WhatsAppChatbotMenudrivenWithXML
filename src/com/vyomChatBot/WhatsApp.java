	...
	{		
		...
		{			
			try 
			{
				...
				{
					Ex.printStackTrace();
					System.out.println("customerLastMsg : " + customerLastMsg);
					archiveContact();
			...
			switch(userState)
			{
				case 1 :
							if (userReplay.equalsIgnoreCase("Hi")||userReplay.equalsIgnoreCase("Hello")||userReplay.equalsIgnoreCase("Hey")) 
							{
								...
								reply = reply+""+obj.MenuOptions("");			//get menu list from XML file
								sendMessage(userNo, reply);								
								map_UserState.put(userNo, 2);		//Set UserState 2 for further communication								
							}
							else
							{
							...
							break;
				case 2 : 	reply = reply+""+obj.MenuOptions(userReplay);
							sendMessage(userNo, reply);
							if(userReplay == "0")
							{
